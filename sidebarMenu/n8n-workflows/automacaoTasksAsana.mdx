---
title: "Workflow — Gerar Tasks da Reunião (FireFiles → n8n → Supabase/Asana)"
sidebarTitle: "Gerar Tasks da Reunião"
---
...
- Todo início de reunião, os participantes devem ser adicionados na reunião.
...
- **Validações**:
  ...
  - Valida se teve participantes na reunião
...
- **HTTP Request**: Busca os usuários da equipe no Asana
